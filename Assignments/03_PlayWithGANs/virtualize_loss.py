...
for dataset_name in dataset_names:
    ...
    plt.plot(data['Epoch'], data['G Loss'], label='Generator Loss')
    plt.plot(data['Epoch'], data['D Loss'], label='Discriminator Loss')
    ...
    # 保存图表
    plt.savefig(os.path.join(current_path, "logs", f'loss_curve_{dataset_name}.png'), dpi=300, bbox_inches='tight')
